...
class DataIngesion:
    ...
    def initiate_data_ingestion(self):
        logging.info('Entered the data ingestion or component part.')
        try:
...
if __name__ == "__main__":
    ...
    train_arr, test_arr, preprocessor_obj_file_path = data_transformaion.initiate_data_transformation(train_data, test_data)
